...
public class OneDirectionalAdjMatrixListFriendshipMap {

	private AdjMatrixListGraph map = new AdjMatrixListGraph();
	
	public OneDirectionalAdjMatrixListFriendshipMap() {
		map.addNode("Rob");
		map.addNode("Bob");
		map.addNode("Mark");
		map.addNode("Alice");
	...
	public static void main(String[] args) {
		new OneDirectionalAdjMatrixListFriendshipMap();
	}
